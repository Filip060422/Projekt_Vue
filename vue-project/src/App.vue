...
<style scoped>
    ...
    div.second-page h2, div.third-page h2 {
        font-size: 48px;
        font-weight: bold;
        color: #543E3C;
        margin: 50px 0;
    }
    div.second-page div.cards {
        display: flex;
        justify-content: space-between;
    }
    div.second-page input, div.third-page input {
        margin: auto;
        margin-top: 50px;
        display: flex;
    }
    ...
    div.second-page a {
        ...
        font: normal normal 600 21px/117px Poppins;
